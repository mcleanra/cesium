define([
     ...
     * @param {Resource|String} [options.xysFileUrlTemplate='Assets/IAU2006_XYS/IAU2006_XYS_{0}.txt'] A template URL for obtaining the XYS data.  In the template,
    ...
    function requestXysChunk(xysData, chunkIndex) {
        ...
        if (defined(xysFileUrlTemplate)) {
            ...
            chunkUrl = new Resource({
                url : buildModuleUrl('Assets/IAU2006_XYS/IAU2006_XYS_' + chunkIndex + '.txt')
            });
        }
